...
namespace Life
{
	...
	class Life
	{
		int Height = File.ReadAllLines("/Users/home/Desktop/C#Proj/LifeGameInitial.txt").Length;
		int Width = File.ReadAllLines("/Users/home/Desktop/C#Proj/LifeGameInitial.txt")[0].Length;
		...
		public void InitState()
		{
            for (int i = 1; i < Height+1; i++)
			{
				...
				{
                    LifeArrayPrevStep[i, j] =Int32.Parse((File.ReadAllLines("/Users/home/Desktop/C#Proj/LifeGameInitial.txt")[i-1]).Substring(j-1,1));
				}
